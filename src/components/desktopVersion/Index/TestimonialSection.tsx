...
const TestimonialSection = () => {
  return (
    <section className="py-20 bg-black relative overflow-hidden" aria-labelledby="filosofia-heading">
        ...
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <div className="relative">
            ...
            <div className="relative z-10 py-16">
              <h2 id="filosofia-heading" className="sr-only">Nossa Filosofia Musical</h2>
