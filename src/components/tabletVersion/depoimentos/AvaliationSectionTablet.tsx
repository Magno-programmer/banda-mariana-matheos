...
const AvaliationSectionTablet = () => {
  ...
  return (
    <section className="py-16 jazz-gradient relative">
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="font-gatsbybold text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="text-center mb-12 animate-scale-in">
          <div className="bg-black bg-opacity-40 p-6 border-2 border-jazz-gold border-opacity-50 max-w-xl mx-auto rounded-lg">
            <div className="flex justify-center items-center gap-2 mb-3">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-5 h-5 fill-jazz-gold text-jazz-gold" />
              ))}
            </div>
            <h2 className="font-glimmer text-xl jazz-gold font-bold mb-2">
        ...
        <div className="mb-16 animate-fade-in">
          <h2 className="font-glimmer text-3xl font-bold text-white mb-4 text-center jazz-text-shadow">
                  ...
                  <div className="p-2">
                    <Card className="bg-black bg-opacity-40 border-2 border-jazz-gold border-opacity-30 hover:border-opacity-100 transition-all duration-300 h-full">
                      <CardContent className="p-4 text-center h-full flex flex-col justify-between">
                        {renderStars()}
                        <blockquote className="font-gatsbybold text-gray-200 text-base leading-relaxed mb-3 flex-grow">
                          "{review.review}"
                        </blockquote>
                        <cite className="font-glimmer text-jazz-gold font-bold text-lg">
                          — {review.name}
                        </cite>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-black bg-opacity-40 border-2 border-jazz-gold border-opacity-30 hover:border-opacity-100 transition-all duration-300 h-full">
                      <CardContent className="p-4 text-center h-full flex flex-col justify-between">
                        ...
                        <div className="text-center">
                          <cite className="font-glimmer text-jazz-gold font-bold text-lg block">
                            — {review.name}
                          </cite>
        ...
        <div className="text-center mt-16 animate-scale-in">
          <div className="bg-black bg-opacity-40 p-6 border-2 border-jazz-gold border-opacity-50 max-w-2xl mx-auto rounded-lg">
            ...
            <p className="font-gatsbybold text-lg text-gray-400 mb-6">
              Junte-se aos nossos clientes satisfeitos e garanta uma apresentação inesquecível
            </p>
            <a 
              ...
              className="inline-block font-gatsby text-base px-6 py-3 bg-jazz-gold text-black hover:bg-yellow-400 transition-all duration-300 tracking-wider uppercase font-semibold rounded"
            >
              Solicitar Orçamento
            </a>
          </div>
...
export default AvaliationSectionTablet;
