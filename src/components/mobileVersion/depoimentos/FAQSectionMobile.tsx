        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 mb-12">
            {faqs.map((faq, index) => (
              ...
              >
                <h2 className="font-glimmer text-2xl jazz-gold font-bold mb-3 leading-tight">
                  {faq.pergunta}
                </h2>
          ...
          <div className="text-center animate-scale-in">
            <div className="bg-black bg-opacity-40 p-6 border border-jazz-gold border-opacity-50">
              ...
              <p className="font-gatsbybold text-xl text-gray-300 mb-4">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="block w-full px-6 py-3 bg-jazz-gold text-black hover:bg-yellow-400 transition-all duration-300 font-gatsbybold font-semibold"
                >
                  Falar no WhatsApp
                </a>
                <button
                  onClick={() => navigate('/contato')}
                  className="w-full px-6 py-3 border border-jazz-gold text-jazz-gold hover:bg-jazz-gold hover:text-black transition-all duration-300 font-gatsbybold"
                >
                  Ver Mais Contatos
                </button>
              </div>
