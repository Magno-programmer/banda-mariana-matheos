    ...
    <section id="contato" className="py-20 bg-black relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-3xl text-gray-50 font-gatsby">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-gradient-to-br from-black to-jazz-dark border border-jazz-gold rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6 font-gatsbybold text-gray-300 text-2xl">
            ...
            <div className="bg-gradient-to-br from-black to-jazz-dark border border-jazz-gold rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-4">
                ...
                <button
                  onClick={() => navigate('/')}
                  className="w-full font-gatsbybold text-gray-50 text-2xl bg-transparent border border-jazz-gold text-jazz-gold font-gatsby py-3 rounded hover:bg-jazz-gold hover:text-black transition"
                >
                  Voltar ao Início
                </button>
              </div>
...
const ContactItem = ({ icon: Icon, label, value }) => (
  <div className="flex items-center space-x-4">
    ...
    <div>
      <p className="text-2xl font-bold text-jazz-gold">{label}</p>
      <p className="text-xl break-words text-gray-300">{value}</p>
    </div>
  </div>
);
...
const ActionButton = ({ href, icon: Icon, text }) => (
  <a
    ...
    className="w-full text-2xl flex items-center justify-center space-x-3 border border-jazz-gold text-jazz-gold font-gatsbybold py-3 rounded hover:bg-jazz-gold hover:text-black transition"
  >
    <Icon size={22} />
    <span>{text}</span>
  </a>
