...
const RepertoireSection = () => {
  ...
  const padding = isMobile ? 'px-4' : isTablet ? 'px-16' : 'px-32';
  const minHeight = isMobile ? 'min-h-[120px]' : isTablet ? 'min-h-[140px]' : 'min-h-[170px]';
      ...
      <div className="container mx-auto px-6 relative">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12 animate-fade-in">
            <p className={`font-gatsby ${textSize} text-gray-300 leading-relaxed mb-8`}>
            ...
            {/* Artists Grid */}
            <div className={`grid ${gridCols} ${padding} mb-12`}>
